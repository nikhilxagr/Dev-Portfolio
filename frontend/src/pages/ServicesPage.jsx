              ...
              >
                ...
                {isActiveService ? (
                  <div className="mt-4 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-4">
                    ...
                    {!isLoggedIn ? (
                      <div className="mt-3 rounded-2xl border border-emerald-500/40 bg-emerald-500/10 p-5 text-center shadow-md">
                        <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500/20">
                          <GoogleIcon />
                        </div>
                        <p className="mt-2 text-xs font-extrabold text-slate-900 dark:text-white">
                          Sign In Required to Enroll
                        </p>
                        <p className="mt-1 text-[11px] text-slate-600 dark:text-slate-400 font-medium max-w-sm mx-auto">
                          Please sign in with Google first to unlock the checkout details and receive your official course enrollment receipt.
                        </p>
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className="mt-4 inline-flex items-center justify-center gap-2.5 rounded-xl bg-white dark:bg-slate-900 px-5 py-2.5 text-xs font-extrabold text-slate-800 dark:text-slate-100 border border-slate-300 dark:border-slate-700 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition"
                        >
                          <GoogleIcon />
                        ...
                        <div className="mt-3 grid gap-3 sm:grid-cols-2">
                          ...
                          <label className="text-xs font-bold text-slate-800 dark:text-slate-300">
                            ...
                            <input
                              ...
                              className="mt-1 w-full rounded-xl border border-slate-300 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/60 px-3 py-2 text-xs font-medium text-slate-600 dark:text-slate-400 cursor-not-allowed font-semibold outline-none"
