...
const TECH_ICONS = {
  ...
  MongoDB:        { bg: "bg-[#47A248]/10", border: "border-[#47A248]/35", text: "text-[#47A248]" },
        ...
        <div className="mt-5 flex gap-2.5">
          ...
          {project.githubUrl ? (
            <a
              ...
              className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-slate-100 text-slate-800 hover:bg-slate-200 dark:border-white/15 dark:bg-white/5 dark:text-slate-200 dark:hover:border-white/30 dark:hover:bg-white/10 dark:hover:text-white px-4 py-2.5 text-xs font-black uppercase tracking-widest transition-all duration-200"
            >
              <GitHubMark className="h-3.5 w-3.5" />
              Code
            </a>
          ) : (
            <span className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-slate-100 text-slate-400 dark:border-slate-700/40 dark:bg-slate-800/30 dark:text-slate-600 px-4 py-2.5 text-xs font-black uppercase tracking-widest">
              <GitHubMark className="h-3.5 w-3.5" />
              Code
            </span>
          )}
          ...
          {project.liveDemoUrl ? (
            <a
              ...
              className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-green-500 text-black px-4 py-2.5 text-xs font-black uppercase tracking-widest transition-all duration-200 hover:bg-green-400 hover:shadow-[0_6px_20px_rgba(34,197,94,0.4)]"
            >
              Demo
              <ExternalLink size={11} />
            </a>
          ) : (
            <span className="flex flex-1 items-center justify-center rounded-xl bg-green-500/10 border border-green-500/20 text-green-700 dark:bg-green-500/20 dark:border-green-500/30 dark:text-green-600 px-4 py-2.5 text-xs font-black uppercase tracking-widest">
              Demo
            </span>
          )}
        </div>
