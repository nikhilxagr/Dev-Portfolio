...
export const journeyData = [
  ...
  },
  {
    ...
    location: "Remote",
    description:
      "Accepted as an Open Source Contributor for the Elite Coders Summer of Code (ECSoC) 2026, contributing to the UI Components track. Collaborating with a global developer community.",
    imageUrl: "/images/journey/top1-thm.png",
    imageFit: "contain-dark",
    hasCertificate: false,
    certificateUrl: "",
    ...
    tag: "Open Source",
    skills: ["Open Source", "UI Components", "React"],
    details: {
      university: "Elite Coders Community",
      course: "ECSoC 2026 — UI Components Track",
      status: "In Progress",
      journeyTitle: "Elite Coders Summer of Code 2026",
      overview: "Selected as an Open Source Contributor for ECSoC 2026. Contributing code, documentation, and accessible UI component libraries.",
      skills: ["Open Source", "React", "UI Components", "TypeScript", "Git"],
